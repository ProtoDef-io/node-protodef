...
function readVarInt (buffer, offset) {
  ...
  throw new assert.AssertionError('varint is too big') // Make sure our shift don't overflow.
}
...
function writeVarInt (value, buffer, offset) {
  while (value & ~0x7F) {
    offset = buffer.writeUInt8((value & 0xFF) | 0x80, offset)
    value >>>= 7
  }
...
function writePString (value, buffer, offset, typeArgs, rootNode) {
  ...
  return offset + buffer.write(value, offset, length, 'utf8')
}
